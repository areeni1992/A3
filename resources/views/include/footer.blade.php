        ...
        <div class="row">
            <div class="col-lg-4 col-md-6 mb-4 mb-md-0 text-center text-md-start">
                <ul class="list-unstyled mb-0">
                    <li>
                        <a href="#" class="text-dark"><img src="assets/img/logo.jpg" alt="Error In Download The Image" class="img-fluid rounded-circle" width="90"></a>
                        <p class="text-muted mt-3">
                            Lorem ipsum dolor sit amet consectetur, adipisicing elit.
                            Adipisci, modi laboriosam quod optio deleniti maiores,
                            consectetur impedit itaque quae ea sunt beatae numquam
                            minima eius ipsum.
                        </p>
                    </li>
                </ul>
            ...
            <div class="col-lg-2 col-md-6 mb-4 mb-md-0">
                ...
                <ul class="list-unstyled text-decoration-none">
                    ...
                    <li>
                        <a href="#" class="text-dark text-decoration-none text-muted">Whatsapp Chatbot
                        </a>
                    </li>
                    <li>
    ...
    <div class="copyright p-3 bg-light text-center text-md-start">
        <div class="row">
            <div class="col-md-4 text-">
                ...
                <a href="#">
                    <img src="assets/img/logo.jpg" class="img-fluid rounded-circle" alt="Error in Download The  Image" width="20">
                </a>
            </div>
