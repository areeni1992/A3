...
@section('content')
    ...
    <form action="{{ route('policySetting', $agenstData->id ?? '') }}" method="POST" enctype="multipart/form-data">
        @csrf
        @if(!empty($agenstData))<input type="hidden" name="_method" value="PUT">@endif
